...
<body>
			...
			<div class="col-md-3">
				<div class="list-group">
					<a href="#" class="list-group-item list-group-item-action active"
						...
						sách đoàn viên</a> <a href="danhSachDoanVienNopTien.jsp"
						class="list-group-item list-group-item-action">Danh sách đoàn
						viên nộp tiền</a> <a href="danhSachDoanVienChuaNopTien.jsp"
						class="list-group-item list-group-item-action">Danh sách đoàn
						viên chưa nộp tiền</a>
				</div>
			</div>
			<div class="col-md-9">
				<div class="card">
					<div class="card-header">
						...
						<a href="admin/form.jsp" class="btn btn-dark">Thêm đoàn viên+</a>
					</div>
					<div class="card-body">
 ...
 %></td>
										...
										<td><a  data-bs-toggle="modal"
											data-bs-target="#modalki" href="${o.maSinhVien}"
											class="btn btn-primary xemki">Kì nộp</a></td>
										<td><a href="updateServlet?id=${o.maSinhVien}"
											class="btn btn-primary ">Sửa</a> <a
											href="DeleteDssv?id=${o.maSinhVien}"
	...
	<script>
		...
		var msv = ${sessionScope.account.maSinhVien};
		console.log(msv);
