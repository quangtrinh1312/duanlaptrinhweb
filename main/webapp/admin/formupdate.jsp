...
<body>
	<div class="container">
		...
		<input type="hidden" value="${doanvien.maSinhVien}" name="id"/>
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Họ tên:
					</label> <input value="${doanvien.hoTen}" name="hoTen" type="text" class="form-control"
					id="exampleInputEmail1" aria-describedby="emailHelp" required>
			</div>
			<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Ngày Sinh:
					</label> <input value="${doanvien.ngaySinh }" name="ngaySinh" type="date" class="form-control"
					id="exampleInputEmail1" aria-describedby="emailHelp" required>
			</div>
